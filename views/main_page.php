...
<body>
    ...
    <section class="banner">
        <img class="banner__img" src="images/<?= $lastNews['image'] ?>" alt="Последние новости" loading="lazy"/>
        <div class="banner__content">
            <div class="container container--banner">
                <h2 class="banner__title"><?= $lastNews['title'] ?></h2>
                <h3 class="banner__announce"><?= $lastNews['announce'] ?></h3>
            </div>
        </div>
    </section>
    ...
    <main class="news container">
        ...
        <div class="news__list">
            <?php foreach ($currentNewsList as $news): ?>
        ...
        <div class="pagination">
            ...
            <?php if (!($paginationPages <= 1) && $currentPage < max($paginationPages)): ?>
                <a class="pagination__link pagination__link-arrow" href="index.php?page=<?= $currentPage + 1 ?>#news">
